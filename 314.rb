...
# 1 ask user for single word
# 2 removes the first letter of the word
# 3 move removed letter to the end of the word
# 4 adds "ay" to the end of the word
# 5 print pig latin word

puts "please type one word"
word = gets.chomp
letters = word.split(//)
index = 0 
pig_latin = ""
...
index = index + 1 
    ...
    # if index is < letters.length
        # adding letter to new string
    #if index is = letters.length
        #append to the new string the first letter 
