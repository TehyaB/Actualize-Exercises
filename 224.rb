...
if 2 > 3          # 6 (2 is not bigger than 3, skip)
  x = 10          
  if 2 == 2       
    y = 20        
    if 3 == 3     
  ...
  if x < 100      # 11 (x is 70, which is than 100)
    w = 8         # 12 (v is 1, w is 8, x is 70, y is 80, z is 5)
    if z == 30    # 13 (z is 5, which is not equal to 30)
      y = 100     
    else          
      y = 14      # 14 (v is 1, w is 8, x is 70, y is 14, z is 5) 
      if w > 10   # 14 (w is 8, which is less than 10)
        v = 1000  
      end         
    end           
  else            
