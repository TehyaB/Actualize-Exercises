...
#yes, however I forgot to add "end" so that something i need more practice with so that I dont forget. 
#tomorrow I plan on continuing my practice with writing if statements. 